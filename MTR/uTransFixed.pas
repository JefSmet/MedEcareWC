...
type
  ...
  TFixed = record
    ...
    class function PadLeft(const S: string; Len: Integer; C: Char = '0'): string; static;
  end;

const
  TRANS_VERSION = 'Versie 1.16'; // spec §Header :contentReference[oaicite:0]{index=0}:contentReference[oaicite:1]{index=1}
